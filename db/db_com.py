...
def cal_fee(enter_time):
    ...
    # 초당 100원
    fee = 0
    sec = (exit_sec - enter_sec) * 100
    min = (exit_min - enter_min) * 60 * 100
    hour = (exit_hour - enter_hour) * 60 * 60 * 100
    day = (exit_day - enter_day) * 24 * 60 * 60 * 100
...
host = '10.10.59.205' # host ip : db server
port = 27017
username = 'rpi'
password = '1234'   
